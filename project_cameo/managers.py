...
class CaptureManager(object):
    ...
    def enterFrame(self):
        ...
        """
        # but first, check that any prvious frame was exited
    ...
    def exitFrame(self):
        ...
        #check whether any grapped frame is retrievable.
    ...
    def startWritingVideo(self,filename,
        ...
        """start write exited frames to a video file"""
        self._videoFilename = filename
        self._videoEncoding = encoding

    def stopWritingVideo(self):
        """Stop write exited frames to a video file"""
        self._videoFilename = None
        self._videoEncoding = None
        self._videoWriter = None
